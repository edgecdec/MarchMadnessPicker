...
- [2026-03-15 03:10] **Leaderboard missing upset bonus points**: The total score is correct (includes upset bonuses) but the round-by-round breakdown columns don't include upset bonus points, and there's no separate column showing bonus points earned. The round scores should either include the bonus in each round's total, or there should be a separate "Bonus" column. Currently the per-round scores add up to less than the total because bonuses are missing from the breakdown.
